  ...
  const faqData = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Le Cabinet Dentaire Vang est situé au 19 Avenue de la Faïencerie, L-1510 Limpertsberg. Facilement accessible en transport en commun (tram Faïencerie, bus Henri VII) et à proximité du parking Glacis. Ouvert du lundi au vendredi de 9:45 à 18h30."
        }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Pour prendre rendez-vous au Cabinet Dentaire Vang, vous pouvez appeler au +352 26 26 20 46, envoyer un email à dentiste1510@gmail.com, ou réserver en ligne via notre site web. Nous proposons des créneaux du lundi au vendredi avec une équipe multilingue (français, anglais, néerlandais, turc, russe, espagnol, portugais)."
        }
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Le Cabinet Dentaire Vang à Limpertsberg est ouvert du lundi au vendredi de 9:45 à 18h30. Nous sommes fermés le samedi et le dimanche. Prenez rendez-vous au +352 26 26 20 46 ou via notre site web pour choisir le créneau qui vous convient."
        }
      }
    ]
  };
